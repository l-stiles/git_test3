...
{ 
  ...
  while(!GPIO_ReadInputPin(DHT11_PORT,DHT11_PIN));//DHT11   等待80us低电平响应信号结束
  while(GPIO_ReadInputPin(DHT11_PORT,DHT11_PIN));//DHT11   将总线拉高80us
...
{ 
  ...
  {
    sbuf<<=1; 
    while((!GPIO_ReadInputPin(DHT11_PORT,DHT11_PIN)));//50us的开始低电平
